...
//     try {
//       const response = await fetch(`/api/orders?status=all&period=${orderFilter}`, {
//         headers: {
...
//     try {
//       const response = await fetch(`/api/orders/stats/overview?period=${orderFilter}`, {
//         headers: {
//           'Authorization': `Bearer ${localStorage.getItem('token')}`
//         }
//       });
...
//                   <td className="py-3 px-4 font-medium text-primary-600">{order.invoiceNo}</td>
...
import Modal from '../components/Modal';
import { toast } from 'react-toastify';
import { getOrders, getOrderStats, updateOrderStatus } from '../Helper/apiHelper';
